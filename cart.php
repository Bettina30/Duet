                    ...
                    if(isset($_COOKIE['user_cart'])){
                        ...
                        <?php    } ?>
                                ...
                                <form action="instamojo.php" class="checkout-form pull-right" method="POST">
                                    ...
                                    <input type="submit" class="btn btn-md btn-success" value="Online payment">
                                </form>
                                <?php }else{ ?>
                                    <a class="btn btn-sm btn-success pull-right" href="#" data-toggle="modal" data-target="#userLogin_form" >Online payment</a>
                                <?php } ?>
